...
urlpatterns = [
    ...
    url('^task_list_search.html$', views.task_list_search, name='task_list_search.html'),
    url('^task_blurred_list.html$', views.task_blurred_search, name='task_blurred_list.html'),
